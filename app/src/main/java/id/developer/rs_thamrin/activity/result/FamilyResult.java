...
public class FamilyResult extends AppCompatActivity implements TypeOfIdentityCardAdapter.DataListener {
    public static final int REQUEST_ADD = 20;
    public static final int REQUEST_BACK = 2;

    private static final String TAG = FamilyResult.class.getName();
    ...
    private void fetchData() {
        ...
        Call<ResponseBody> callFamily = dataApi.getFamily();
        callFamily.enqueue(new Callback<ResponseBody>() {
            @Override
